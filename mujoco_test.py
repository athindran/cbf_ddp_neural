...
params = model.load_params(f'/home/arkumar/2024_Exploration/brax_testing/models/{env_name}_params')
...
media.write_video(f'/home/arkumar/2024_Exploration/brax_testing/videos/reacher.mp4',
