...
from .pvtol_margins_and_costs import PvtolReachAvoid6DMargin

class Pvtol6DEnv(BaseSingleEnv):
    # region: init
    def __init__(self, config_env, config_agent, config_constraint) -> None:
        ...
        x_max, y_max =  config_env.WIDTH_LEFT, config_env.HEIGHT_TOP
    ...
    def build_obs_rst_space(self, config_env, config_agent, config_constraint):
        ...
        # Observation space.
        x_min, y_min = reset_space[0, 0], reset_space[1, 0]
        x_max, y_max = reset_space[0, 1], reset_space[1, 1]
