...
class BarkourEnv(PipelineEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if testing:
            path = epath.Path('/Users/athindranrameshkumar/Documents/Code/mujoco_menagerie/google_barkour_v0/scene_mjx_test.xml')
        else:
            path = epath.Path('/Users/athindranrameshkumar/Documents/Code/mujoco_menagerie/google_barkour_v0/scene_mjx.xml')
